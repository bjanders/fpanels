...
still change. The library has been verified to work on Linux and Windows so far. There
is however https://github.com/bjanders/fpanels/issues/2[some issue with the multi panel
display on Windows] and I get a "bad access" error code on macOS 11.1.
